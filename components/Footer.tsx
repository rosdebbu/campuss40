        ...
        <footer className="bg-stone-800 text-stone-300">
            <div className="container mx-auto px-4 py-12">
                        ...
                        <h3 className="text-lg font-semibold text-white mb-4">SUPPORT</h3>
                         <ul className="space-y-2 text-sm">
                            <li className="flex items-center">
                                <span className="bg-red-500 text-white text-xs font-bold px-2 py-0.5 rounded mr-2">SOS</span>
                                Emergency: 112
                            </li>
                             <li className="flex items-center">
                ...
                <div className="mt-12 border-t border-stone-700 pt-6 text-center text-sm text-stone-400">
                    ...
                    <p>Made with <span className="text-red-500">&hearts;</span> for students.</p>
                </div>
            </div>
        </footer>
    );
